...
<body>
	  <button id="btningresar">fasfs</button>
		<div class="container">
			<div class="row">
            
		<div class="col-xs-6">
			<h1><a href=" "><img alt="" class="rounded-circle" style="width: 20%" src="../img/Logo.png" /> DRAW CREATE</a></h1>
		</div>
		<div class="col-xs-6 text-right">
							<div class="panel panel-default">
							<div class="panel-heading">
									<h4>NIT : 
										<a href="#">4534664234234</a>
									</h4>
			...
			<hr />
				...
				<div class="row">
					<div class="col-xs-12">
						<div class="panel panel-default">
								<div class="panel-heading">
                                    <h4>Bucarmanga ,Santande <a href="#"><?php  ?></a> de <a href="#">abril</a> de 201<a href="#">4</a>
...
<pre></pre>
	...
	<div class="row">
			<div class="col-xs-4">
				<h1><a href=" "><img alt="" src="../css/image/qr.png" /></a></h1>
			</div>
			<div class="col-xs-8">
